...
import 'package:wave/utils/lang_mapping.dart';
            ...
            children: [
              ...
              CustomExpansionTile(
                ...
                children: [
                  ListTile(
                    contentPadding: const EdgeInsets.only(left: 5, right: 10),
                    title: Text("Wave Music by Asim Sidd".tr),
                    subtitle: Text(
                      "${"githubDes".tr}${((Get.find<PlayerController>().playerPanelMinHeight.value) == 0 || !isBottomNavActive) ? "" : " ${"by".tr} Asim Sidd"}",
                      style: Theme.of(context).textTheme.bodyMedium,
                    ),
                    isThreeLine: true,
                   onTap: () {
